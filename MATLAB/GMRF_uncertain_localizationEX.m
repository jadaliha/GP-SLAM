function GMRF_uncertain_localizationEX()
% =========================================================================
%                   ------------------------------
...
globaloption.kappa = 1000000; globaloption.alpha = 0.0001;               %get rid of gaussian process in model by using big kappa        
globaloption.hyperparameters_possibilities = ...
    [globaloption.kappa,          globaloption.alpha,       1] ;
tmp1 = prec_mat_5by5(globaloption.hyperparameters_possibilities(1,1)...
    ,globaloption.hyperparameters_possibilities(1,2),nx,ny);
allposibleQz = reshape(tmp1,[],1); 
allposibleQzInverse = reshape(tmp1^(-1),[],1);  
